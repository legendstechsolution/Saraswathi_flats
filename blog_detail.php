...
<html lang="en">
                  ...
                  <div class="col-lg-7 col-md-7 col-sm-7">
                     <div class="logoright-section">
                        ...
                        <div class="single-logo-right">
                           ...
                           <div class="logo-right-text">
                              <a href="mailto:nanandn@gmail.com"><h4>Mail us</h4>
                            <p>nanandn@gmail.com</p></a>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="single-blog blog-page-post">
                              <div class="blog-img">
                                 <img src="<?php echo "admin/images/".$row_blog['image']; ?>" alt="blog-image"/></div>
                              <div class="blog-heading">
                                 <h3><?php echo $row_blog['title']; ?></h3>
                              </div>
                              <div class="blog-comnt">
                                 <p><i class="fa fa-user"></i> Admin</p>
                                 <p><i class="fa fa-calendar"></i><?php echo $row_blog['date']; ?></p>
                              </div>
                              <div class="blog-details">
                                 <p class="text-justify"><?php echo $row_blog['des']; ?></p><br>
 ...
 ?>
       ...
       <span style="margin-left:10px;" id="like"> <?php echo $count_fet['likes'];?> </span> <span style="margin-left:40px;" id="dislike"> <?php echo $count_fet['dislikes'];?></span>
  ...
  this.classList.toggle('red');
  	...
  	$.ajax({
                                ...
                                <div class="col-md-9">
                                  <div class="construct-contact-form-right">
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                           <p>
                                              <button type="submit" name="comment" class="construct-btn btn btn-sm">comment</button>
                                           </p>
                                        </div>
                                     </div>
                                  </form>
        ...
        <div class="container bg-light">                       
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                    <p class= "pl-5 pr-5 text-danger" ><b><?php echo $row_c['name'];?> &nbsp <small><?php echo $row_c['date'];?></small></b></p>
                                    <p class= "pl-5 pr-5 text-justify text-danger"><?php echo $row_c['comment'];?> &nbsp</p> <br> 
     ...
     <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-11 ">
                                            <p>You can reply here...</p></p>
                                        <div class="form-group">
                                          <input type="hidden" name="comment_id_1" class="form-control mb-2" value="<?php echo $row_c['id']; ?>">  
                                          <input type="text" id="r_name" name="r_name" class="form-control mb-2" placeholder="Name..." required>  
                                          <input type="text"  id="r_email" name="r_email" class="form-control mb-2" placeholder="Email..." required> 
                                          <textarea type="" name="r_reply" class="form-control mb-2"  placeholder="Reply..."></textarea>
                                          <button type="submit" name="reply1" class="btn btn-info btn-sm">Reply</button><br><br>
                                        ...
                                        <div class="col-md-11">  
                                         ...
                                         <?php
                                            ...
                                            ?>
                                                ...
                                                <p style="color: #ce8f00;"><b><i><?php echo $row_r1['name'];?> &nbsp <small><?php echo $row_r1['date'];?></small></i></b><br>
                                                <i><?php echo $row_r1['reply'];?></i></p>
                     ...
                     <div class="construct-shop-widget">
                        ...
                        <?php
                            ...
                            <ul class="related-shop-pro">
                               <li>
                                  <div class="pro-img">
                                     <img src="<?php echo "admin/images/".$row_blog1['image']; ?>" style="width:60px; height: 60px;" />
                                  </div>
                                  <div class="pro-text">
                                     <h4><a href="blog.php?blog_id=<?php echo $row_blog1['id'];?>"><?php echo $row_blog1['title']; ?></a></h4>
                                     <p class="pro-price"><small><?php echo $row_blog1['date']; ?></small></p>
                                  </div>
                               </li>
                            </ul>
                         <?php
