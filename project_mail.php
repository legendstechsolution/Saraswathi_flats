...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM brochure_requests WHERE id= '$id'";
...
$sql_mail = "SELECT * FROM brochure_requests ORDER BY id DESC";
                    ...
                    <div class="col-md-10">
                        <div class="mainmenu">
                            <ul id="construct_navigation">
                                ...
                                <li class="current-page-item"><a href="project_mail.php">Project Form</a></li>
                            ...
                            <tbody>
                                ...
                                while ($row_mail = mysqli_fetch_array($result_mail)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="project_mail.php?delete_id=<?php echo $row_mail['id']; ?>"
