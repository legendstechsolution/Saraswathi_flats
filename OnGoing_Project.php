                    ...
                    <div class="single-service">
                        <div>
                            <h3 class="">LOTUS
                                ...
                                <span>For Sale @MADIPAKKAM</span>
                            </h3>
                            <br>
                            <p class=" text-justify mb-1">Discover the charm of Lotus 2 BHK flats, meticulously designed
                                for
                                modern living. Located
                                in the vibrant neighborhood of Madipakkam. Experience the
                                assurance of quality, quick turnaround, and the best service with Lotus 2 BHK Flats.</p>
                        ...
                        <div class=" mt-3">
                            <a href="flats.php" type="button" class="construct-btn btn " target="_blank">View More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="single-service">
                        <div class="service-image">
                            ...
                            <img class="rounded" src="assets/assets/img/projects/pro1.jpg" />
