      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-5 pr-5 ">
               <div class="single-service">
                  <div>
                     <h3>NEW RESIDENTIAL BUILDINGS</h3><br>
                     <p class=" text-justify">'New build' is a term that denotes new construction of all types of
                        structures such as houses, apartments, office blocks and so on.
                        Assistance in Planning and Cost Estimate Workings, Proper Guidance and inputs to complete the
                        project as per schedule with good quality. No job is too big or small for us.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <div class="row mt-5">
            ...
            <div class="col-md-5 pr-5 ">
               <div class="single-service">
                  <div>
                     <h3>RENOVATION OF EXISTING HOMES</h3><br>
                     <p class=" text-justify">Renovation is the process of improving a broken or outdated structure.
                        Renovations are of commercial or residential type.
                        This area challenges us and we are specialized to meet your requirements.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <div class="row mt-5">
            ...
            <div class="col-md-5 pr-5 ">
               <div class="single-service">
                  <div>
                     <h3>COMPLETE INTERIOR SOLUTIONS</h3><br>
                     <p class=" text-justify">At Interior Solutions, our services represent our investment in
                        excellence. We’ll design to your specifications, cater to your success.
                        The scope varies from design solutions, sourcing of resources, total execution of the job and
                        handing over to customer satisfaction within a fixed time.
                     </p>
                  </div>
               </div>
            </div>
