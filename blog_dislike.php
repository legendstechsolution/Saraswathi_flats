...
include_once ('connection.php');
    ...
    if($count >=1)
    {
        ...
        $count_fet = $count_fet['dislikes']+1;
        $sql123 = "update blog_liked set dislikes='$count_fet' where blog_id='$blog_id'";
	    $res123 = mysqli_query($conn, $sql123);
    }
    ...
    else
    {
         	...
         	$sql_like = "INSERT INTO blog_liked(blog_id,dislikes) VALUES('$blog_id','1')";
