...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM venture_scs WHERE id= '$id'";
    ...
    if ($result_delete) {
        ...
        echo "</script>";
        echo "<script>window.location='venture_mail.php'</script>";
    }
}


$sql_mail = "SELECT * FROM venture_scs ORDER BY id DESC";
                    ...
                    <div class="col-md-10">
                        <div class="mainmenu">
                            <ul id="construct_navigation">
                                ...
                                <li class="current-page-item"><a href="venture_mail.php">Venture Form</a></li>
                                <li><a href="carrer_mail.php">Carreer Form</a></li>
                            ...
                            <tbody>
                                ...
                                while ($row_mail = mysqli_fetch_array($result_mail)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row_mail['name']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['email']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['number']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['work']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['subject']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['work']; ?>
                                        </td>
                                        ...
                                        <td>
                                            <a href="venture_mail.php?delete_id=<?php echo $row_mail['id']; ?>"
