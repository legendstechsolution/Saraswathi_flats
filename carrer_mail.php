...
$sql_mail = "SELECT * FROM career_applications ORDER BY id DESC";
                    ...
                    <div class="col-md-10">
                        <div class="mainmenu">
                            <ul id="construct_navigation">
                                ...
                                <li class="current-page-item"><a href="carrer_mail.php">career
                                        Form</a></li>
                            ...
                            <tbody>
                                ...
                                while ($row_mail = mysqli_fetch_array($result_mail)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row_mail['apply']; ?>
                                        </td>

                                        <td><a class="btn btn-primary"
                                                href="admin/images/<?php echo $row_mail['resume']; ?>" download> Resume
                                                Download</a>
                                        </td>
                                        <td>
                                            <?php echo $row_mail['salary']; ?>
                                        </td>
                                        <td>
