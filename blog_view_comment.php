 ...
 if(isset($_GET['view_id']))
	{
        ...
        $sql = "SELECT * FROM scs_comment WHERE blog_id= '$view_id' ORDER BY id DESC";
    ...
    if(isset($_GET['delete_id']))
	{
	    ...
	    $sql_delete = "DELETE FROM scs_comment WHERE id= '$id'";
	    $result_delete = mysqli_query($conn, $sql_delete);
	    
	    if($result_delete)
		{
		  echo "<script>";
          echo "alert ('Comment Deleted Sucessfully!')";
          echo "</script>";
          echo "<script>window.location='blog_view_comment.php?view_id='+$view_id</script>";
       	}else
       	{
       	  echo "<script>";
          echo "alert ('Delete Failed')";
          echo "</script>";
          echo "<script>window.location='blog_view_comment.php?view_id='+id</script>";
       	}
         ...
         <div class="container">
            <div class="row">
               <div class=" col-lg-12 col-md-12 col-sm-12">
                <h2 style="color:red;">Blog Comments </h2><br><br>
              ...
              <tbody>   
                ...
                <tr>
				    <td><?php echo $i+1; ?></td>
				   	...
				   	<td>
				   	    <a href="blog_view_reply.php?reply_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">View Reply</a>
				   	    <a href="blog_view_comment.php?delete_id=<?php echo $row['id']."&view_id=" . $row['blog_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete ?');">Delete </a>
				   	</td>
