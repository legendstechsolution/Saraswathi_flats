...
if (isset($_GET['delete_id'])) {
   ...
   $sql_delete = "DELETE FROM scs_mail WHERE id= '$id'";
...
$sql_mail = "SELECT * FROM scs_mail ORDER BY id DESC";
               ...
               <div class="col-md-10">
                  <div class="mainmenu">
                     <ul id="construct_navigation">
                        ...
                        <li class="current-page-item"><a href="mail.php">Contact Form</a></li>
